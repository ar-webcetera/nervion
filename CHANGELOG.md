...
- В разделе Git — копирование команды `git clone` (URL из `GIT_CLONE_BASE_URL` + имя bare-репозитория); исправлена ошибка сборки фронтенда в `:class` с BEM-классом через дефис.
